...
Live Demo: security-questionnaire-library.chrisolowolafe.workers.dev  
Built by: Chris Olowo, PMP® — GRC Analyst & Risk Practitioner
---
Overview
...
Project	Live URL
🏠 ShomriTech GRC Platform	chris-olowo-grc-portfolio.pages.dev
1️⃣ Vendor Risk Assessment Tool	vendor-risk-assessment-tool.chrisolowolafe.workers.dev
2️⃣ User Access Review Tracker	user-access-review-tracker.chrisolowolafe.workers.dev
3️⃣ SOC 2 Evidence Tracker	soc2-evidence-tracker.chrisolowolafe.workers.dev
4️⃣ NIST AI RMF Gap Assessment	nist-ai-rmf-assessment.chrisolowolafe.workers.dev
5️⃣ Security Questionnaire Library (this repo)	security-questionnaire-library.chrisolowolafe.workers.dev
---
Author
Chris Olowo, PMP®  
